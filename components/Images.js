...
import vs from "./glsl/images.vert";
import fs from "./glsl/images.frag";
...
const Images = () => {
  ...
  class EffectCanvas {
    ...
    setupCamera() {
      ...
      // renderer
      const canvas = document.getElementById("dom-gl");
  ...
  return (
    <div id="main" className={styles.main}>
      <canvas id="dom-gl" className={styles.domGL} />
      <div id="scrollable" class={styles.scrollable}>
        <div class={styles.container}>
          <div class={styles.imageContainer}>
            <div className={styles.image}>
              <Image
                priority
                src="/img/van_gogh/garden.jpeg"
            ...
            <p className={styles.paragraph}>
              ...
              garden with lovers&apos;. Couples in love are strolling under the
              young chestnut trees and sitting along the winding paths. <br />
              <br />
              He used a free variation on the technique of the Pointillists.
              They built up their compositions from dots of paint. Van Gogh
              instead applied small brushstrokes of varying length in different
              directions. This helped him to create the effect of a radiant
              spring day, which fit the sense of intimacy and togetherness he
              wished to express. He too longed for a wife and a family, but he
              had &apos;the most impossible love affairs&apos;. He eventually
              resigned himself to the situation; he was devoted to his art
            </p>
          </div>
          <div class={styles.imageContainer}>
            <div className={styles.image}>
